...
class AuthController extends Controller
{
    ...
    */
    ...
    public function handleProviderCallback($provider)
    {
        ...
        try {
            ...
            if (Auth::user()->id) {
                ...
                ->where('organisation.expire_at','>=',date('Y-m-d'))
                ...
                if(sizeof($orginfo)>0){
                    ...
                    return redirect()->intended('organisation/add-organisation');
                }         
            }
        } catch (Exception $e) {
    ...
    public function findOrCreateUser($user, $provider)
    {
        ...
        Mail::send('emails.socialregister', ['userdata' => $userdata], function ($m) use ($user) {
