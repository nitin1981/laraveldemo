...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        try {
            ...
            echo "<script>window.location.href='https://www.merrchant.com/undermaintenance.html'</script>";
        }
       // error_reporting(0);
        ...
        define('MONEYSPEND',501);
        define('MONEYRECEIVE',502);
        define('PLAYARENAINV',601);
        define('PLAYARENABILL',602);
