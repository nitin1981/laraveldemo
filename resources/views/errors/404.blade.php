...
<head>
  ...
  <title>Page not found | Raletta Team</title>
  <!-- plugins:css -->
          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright © 2018 Raletta Technology Pvt Ltd - All Rights Reserved.</p>
              </div>
            </div>
          </div>
        </div>
