...
<script src="{{ asset('public/assets/js/plugins/datepicker/js/bootstrap-datetimepicker.js') }}"></script>
<!-- FastClick -->
...
<script src="{{ asset('public/dist/js/jquery.PrintArea.js') }}"></script>
<script src="{{ asset('public/menus/jquery.smartmenus.js') }}"></script>
