          ...
          <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <div class="dropdown-toggle-wrapper">
                <div class="inner">
                  @if(!empty($v))
                  <img class="img-xs rounded-circle" src="{{$v}}" alt="Profile image">
                  @else
                  <img class="img-xs rounded-circle" src="{{url('public/uploads/userPic/avatar.jpg')}}" alt="Profile image">
                  @endif
                </div>
                <div class="inner">
                  <div class="inner">
                    <span class="profile-text font-weight-bold">{{ Session::get('name') }}</span>
                    <small class="profile-text small">{{Auth::user()->real_name}}</small>
                  </div>
                  <div class="inner">
