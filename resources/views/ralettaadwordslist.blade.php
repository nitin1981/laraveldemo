...
<div class="content-wrapper" style="padding:1.5rem 0.7rem">
  <div class="row grid-margin">
    <div class="col-12">
      ...
      <form action="{{ url('updateleadstatus') }}" method="post" id="myform1" class="form-horizontal" style="overflow: scroll;top: -56px !important;position: relative;">
         ...
         childrow += '</select></td>'+
            ...
            '</tr><tr>' +
                 ...
                 '<button class="btn btn-warning dropdown-toggle" style="padding:10px;width: 100%;margin-top: 22px;" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-magic-wand"></i>Action</button>'+
                      '<div class="dropdown-menu" aria-labelledby="dropdownMenuButton2" style="width:13%;">'+
                        '<a class="dropdown-item" href="#"><i class="icon-paper-plane"></i>&nbsp;&nbsp;Quote</a>'+
                        '<a class="dropdown-item" href="#"><i class="icon-paypal"></i>&nbsp;&nbsp;Invoice</a>'+
                        '<a class="dropdown-item" href="#"><i class="icon-screen-smartphone"></i>&nbsp;&nbsp;SMS</a>'+
                        '<a class="dropdown-item" href="#"><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;Email</a>'+
                        '<a class="dropdown-item" href="#"><i class="icon-layers"></i>&nbsp;&nbsp;Logs</a>'+
                      '</div>'+
                    '</div>' +
